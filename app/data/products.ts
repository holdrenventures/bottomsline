...
const mockProducts: CatalogProduct[] = [
  { id:'prod_mock_001', name:'Support Local Bottoms', slug:'support-local-bottoms', price:32, editorialDescriptor:'Community Outreach', description:'A public service announcement. Support locally.', collection:'Support Local Bottoms', catalogImage:'https://res.cloudinary.com/bihiyho3/image/upload/v1787869598/ChatGPT_Image_Aug_27_2026_05_18_54_PM_1.png', availableSizes:standardSizes, active:true, featured:true, isNewDrop:false, stripeProductId:null, stripePriceId:null, art:['SUPPORT','LOCAL','BOTTOMS'], tone:'coral' },
